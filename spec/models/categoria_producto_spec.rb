...
RSpec.describe CategoriaProducto, type: :model do
   describe "Atributos" do
		...
		it "es válido con todos sus datos" do
			...
			@categoria_producto.categoria = FactoryGirl.build(:categoria_uno)
			@categoria_producto.producto = FactoryGirl.build(:producto1)
		...
		it "es inválido si falta algún dato" do
	  	...
	  	it "es inválido si el par categoria-producto no es único" do
	  		@categoria = FactoryGirl.build(:categoria_uno)
	  		@producto = FactoryGirl.build(:producto1)
